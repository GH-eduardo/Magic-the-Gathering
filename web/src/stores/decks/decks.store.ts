...
export const useDecksStore = defineStore('decks', () => {
    ...
    const deckDetails = ref({
        ...
        description: 'The deck made to do all-win in early game',
        commander: {
            imageUri: "https://cards.scryfall.io/border_crop/front/0/3/034e0929-b2c7-4b5f-94f2-8eaf4fb1a2a1.jpg?1693611218",
        ...
        cards: [
            {
                id: "1",
                name: 'Llanowar Elves',
                imageUri: 'https://cards.scryfall.io/normal/front/8/b/8bbcfb77-daa1-4ce5-b5f9-48d0a8edbba9.jpg?1592765148'
            },
            {
                id: "2",
                name: "Nature's Lore",
                imageUri: 'https://cards.scryfall.io/normal/front/f/5/f5615c05-eb1e-4d27-a323-72d643d7c1d8.jpg?1706547171'
            },
            {
                id: "3",
                name: "Assassin's Trophy",
                imageUri: 'https://cards.scryfall.io/normal/front/e/d/ed6c7d29-71b4-4134-b591-5598f479d592.jpg?1706242115'
            },
            {
                id: "4",
                name: 'Faeburrow Elder',
                imageUri: 'https://cards.scryfall.io/normal/front/c/8/c817cf1f-c0fe-49ab-a8e9-1d09b4c15e57.jpg?1673305511'
            }
        ],
    ...
    async function exportDeck(id: string): Promise<DeckExportDto> {
    ...
    return { getDeckDetails, getDecksOverview, deleteDeck, exportDeck }
})
